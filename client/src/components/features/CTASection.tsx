      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center py-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3 rounded-md transition text-base h-auto group inline-flex items-center justify-center">
              Neem contact met ons op 
              <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/over-ons" className="border-2 border-white/30 text-white hover:bg-white/10 px-8 py-3 rounded-md transition text-base h-auto inline-flex items-center justify-center">
              Meer over ons
            </Link>
          </div>
        </div>
