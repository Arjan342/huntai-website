...
const useCasesData = {
  'financial-institution': {
    ...
    image: '/images/financial-institution.jpg'
  },
  'healthcare-provider': {
...
export default function UseCaseDetailPage() {
  ...
  // Vind de use case op basis van ID
  const useCase = useCasesData[useCaseId];
  
  // Als use case niet gevonden is
  if (!useCase) {
    return (
      ...
      <article className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <div className="h-80 bg-gray-800 rounded-lg flex items-center justify-center mb-8">
            <span className="text-gray-600 text-sm">[Placeholder voor afbeelding: {useCase.image}]</span>
          </div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-8">
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-bold">{useCase.testimonial.author}</p>
                <p className="text-gray-400 text-sm">{useCase.testimonial.position}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <h2 className="text-3xl font-bold mb-6">Klaar om uw eigen succesverhaal te creëren?</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
            Neem contact met ons op om te bespreken hoe HuntAI uw organisatie kan helpen bij het versterken van uw digitale beveiliging.
          </p>
